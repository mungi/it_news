...
## 2026-07-11 업데이트: U-Boot firmware 신뢰 체인
- Binarly의 U-Boot 결함 6건은 OS 아래 bootloader 계층에서 untrusted image parsing이 secure boot 이전 공격 표면이 될 수 있음을 보여줌.
- 클라우드·엣지 운영팀은 OS 패치 외에 firmware SBOM, bootloader version, vendor advisory, remote recovery runbook을 asset 관리에 포함해야 함.
