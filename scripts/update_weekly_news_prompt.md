...
- This applies to every story, not only GeekNews: card summaries and modal details must look like labeled fragments/bullets, not prose paragraphs. Prefer labels such as `핵심:`, `변화:`, `볼 것:`, `영향:`, `시사점:`. Avoid source-led sentences like `OO는 ... 보도했습니다` as the visible summary.
