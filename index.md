...
> Last updated: 2026-09-11 | Total pages: 337

## Entities

## Concepts
- [[concepts/kubernetes-ingress-lifecycle]] — Kubernetes Ingress API와 controller 구현체 수명주기·마이그레이션 리스크.
- [[concepts/ai-inference-infrastructure]] — AI 추론 인프라: 모델·agent harness·GPU/ASIC·SSD·냉각·보안 런타임을 묶은 운영 체계.
- [[concepts/linux-kernel-cloud-security]] — Linux 커널·클라우드 보안: 권한 상승, 컨테이너 host, CI runner 패치 우선순위.
- [[concepts/physical-ai-infrastructure]] — 피지컬 AI 인프라: 로봇·제조 AI·엣지 추론·OT/IT 운영 경계.
...
- [[raw/articles/thn-n-able-ncentral-cve-2026-86218-active-exploitation-2026-09-09]] — N-central `CVE-2026-86218` KEV 등록·active exploitation 보도와 RMM control-plane patch·forensic·tenant closure 검증 경계.
...
- [[raw/articles/zai-glm-5-3-flash-2026-08-26]] — GLM-5.3-Flash native multimodal MoE·hybrid attention·KV cache 비용과 production 검증 경계.
- [[raw/articles/aitimeskr-openai-jalapeno-inference-asic-2026-08-26]] — OpenAI Jalapeño 자체 추론 ASIC의 vendor-reported benchmark·full-stack inference·fleet TCO 검증 경계.
- [[raw/articles/aws-lambda-nodejs26-python315-public-preview-2026-08-25]] — AWS Lambda Node.js 26·Python 3.15 preview runtime의 SLA·지원·자동 GA 승격과 canary 검증 경계.
...
- [[raw/articles/okta-openssl-hollowbyte-dos-2026-07-18]] — OpenSSL TLS length pre-allocation·glibc memory pressure와 package/restart 검증 경계.
...
- [[raw/articles/cloudflare-task-based-oauth-consent-2026-08-21]] — optional OAuth scope와 task 단위 partial grant, MCP·agent delegated identity 검증 경계.
...
- [[raw/articles/rust-arrayref-supply-chain-attack-2026-08-20]] — Rust arrayref·proc-macro1 공급망 공격의 Cargo cache·CI artifact·build-script egress 조사 경계.
