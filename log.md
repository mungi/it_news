...
- Validation passed: `python3 scripts/validate_weekly_news.py` (50 items, 2 Deep Dive entries), `node --check docs/app.js`, `git diff --check`, raw-body SHA-256, and canonical rank/head-tail assertions. Local static-site smoke test on port 61041 rendered 50 cards and 2 Deep Dive entries; programmatic `news-273` click opened the expected modal title with 4 rich sections.
